...
func TestByteUnmarshalJSON(t *testing.T) {
	...
	success := map[string]struct {
		...
		"has key": {
			...
			want: testStruct{
				Req: 100,
				Opt: Byte{v: toPtr(200), hasKey: true},
			},
		},
		"has key(is initial value)": {
			...
			want: testStruct{
				Req: 0,
				Opt: Byte{v: toPtr(0), hasKey: true},
			},
		},
		"has key(is null)": {
