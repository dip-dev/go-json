...
func TestUintUnmarshalJSON(t *testing.T) {
	...
	success := map[string]struct {
		...
		"has key": {
			...
			want: testStruct{
				Req: 100,
				Opt: Uint{v: toPtr(200), hasKey: true},
			},
		},
		"has key(is initial value)": {
			...
			want: testStruct{
				Req: 0,
				Opt: Uint{v: toPtr(0), hasKey: true},
			},
		},
		"has key(is null)": {
